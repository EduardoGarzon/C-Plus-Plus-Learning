/*
    ...
    3.  O Quicksort seleciona um elemento da lista, chamado de pivô,
        ...
        que o pivô fiquem antes dele na lista, e todos os elementos maiores que o pivô fiquem depois dele na lista.
        O pivô então fica em sua posição final na lista ordenada.
        Esse processo é aplicado recursivamente para as sublistas
        formadas antes e depois do pivô, até que toda a lista esteja ordenada.
*/
...
int partition(vector<int> &v, int low, int high)
{
    ...
    */
    ...
    /*
        ...
        Se o elemento atual (v[j]) for menor que o pivô,
        a função incrementa i e troca os elementos v[i] e v[j].
        Isso garante que todos os elementos menores que
        o pivô fiquem à esquerda do índice i na lista.
    */
...
void quicksort(vector<int> &v, int low, int high)
{
    ...
    */
    if (low < high)
    {
        ...
        /*
            A função quicksort é chamada recursivamente para ordenar
            as sublistas formadas antes e depois do pivô.
        ...
        */
        ...
        /*
            ...
            Nesta implementação, o pivô é sempre escolhido
            como o último elemento da lista (v[high]).
        */
    }
}
