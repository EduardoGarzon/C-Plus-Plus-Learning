...
{
    // Realiza a comparação entre dois objetos pessoa
    // utilizando o atributo "nome" como chave.
...
public:
    ...
    Node2(Node2 *prev, const T &x, Node2 *next); // construtor inicializável
    ...
    Node2 *getProximo(); // retorna o ponteiro para o prox elemento;
