// Implementa algoritmos sobre listas simplesmente encadeadas
// implementados como uma classe.
...
public:
   ...
   void insertLeft(T x);  // insere um elemento na esquerdada lista.
   void insertRight(T x); // insere um elemento na direita da lista.
