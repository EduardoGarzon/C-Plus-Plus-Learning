/*
    ...
    Programas que manipulam arquivos em C++
    devem incluir o cabeçalho #include <fstream.h>
...
int main()
{
    ...
    cout << "\n\n\n\n\t\t\tPrograma ExFileMan\n\n\n";
    cout << "\n\n\n\t\tExemplifica a manipulacao de arquivos em C++\n\n";
    ...
    // lê caracteres do arquivo até que seja encontrado
    ...
    // ios::app indica que o arquivo deve ser aberto em modo de "append".
