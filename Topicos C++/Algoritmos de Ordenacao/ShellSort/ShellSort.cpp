...
cada iteração do terceiro laço realiza a inserção do elemento na posição correta dentro do subgrupo.
*/
void shellSort(int arr[], int n)
{
    // divide a lista em grupos menores
    // gap define o tamanho do salto entre os elementos do subgrupo
    // a cada iteracao gap e divido pela metade ate que seja 1 indicando que a lista esta ordenada
