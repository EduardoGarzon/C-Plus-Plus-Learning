...
void merge(vector<int> &v, int left, int mid, int right)
{
    ...
    */
    ...
    {
        /*
            Se o elemento da primeira metade (v[i]) for menor que o elemento da segunda metade (v[j]),
            o elemento da primeira metade é adicionado ao vetor temp, e i é incrementado.
            Caso contrário, o elemento da segunda metade é adicionado ao vetor temp, e j é incrementado.
        */
        if (v[i] < v[j])
        {
            temp.push_back(v[i]);
...
// a função mergesort é chamada recursivamente para dividir a lista em duas metades e ordená-las.
/*
    ...
    */
    if (left < right)
    {
        ...
        /*
            ...
            para ordenar a primeira metade da lista, ou seja, o intervalo de left até mid.
        */
        mergesort(v, left, mid);
        /*
            a função chama recursivamente a função mergesort
            para ordenar a segunda metade da lista, ou seja, o intervalo de mid + 1 até right.
        */
        mergesort(v, mid + 1, right);
        /*
            a função chama a função merge
            para combinar as duas metades ordenadas da lista em uma única lista ordenada.
