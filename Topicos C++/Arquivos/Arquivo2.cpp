...
o arquivo de entrada contém apenas valores numéricos, um em cada linha, 
e que o arquivo de saída conterá apenas um valor, 
...
int main()
{
    ...
    int num = 0;
    int soma = 0;
    // Faz a primeira leitura fora do laco para verificar o fim de arquivo ja na primeira iteracao
    in >> num;
